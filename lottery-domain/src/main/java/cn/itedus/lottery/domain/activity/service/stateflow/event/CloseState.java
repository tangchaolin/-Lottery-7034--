...
public class CloseState extends AbstractState {
    ...
    public Result open(Long activityId, Enum<Constants.ActivityState> currentState) {
        boolean isSucess = activityRepository.alterStatus(activityId,currentState,Constants.ActivityState.OPEN);

        return isSucess?Result.buildResult(Constants.ResponseCode.SUCCESS,"活动开启完成"):
